	...
	private void InitializeStatStacks()
	{
		...
		foreach (var field in properties)
		{
			...
			var statEnum = field.Name switch
			{
				...
				"_runSpeedMultiplier" => CharacterStatType.RunSpeedMultiplier,
				"_staminaMultiplier" => CharacterStatType.StaminaMultiplier,
				"_maxStaminaMultiplier" => CharacterStatType.MaxStaminaMultiplier,
