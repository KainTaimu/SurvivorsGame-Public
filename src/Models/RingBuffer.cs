...
public class CircularBuffer<T> : IEnumerable<T>
{
	...
	/// <summary>
	/// The index of the element that will be set/overwritten when PushBack is called
	/// </summary>
	public int End => _end;
	...
	public CircularBuffer(int capacity, Span<T> items)
	{
		if (capacity < 1)
		{
			throw new ArgumentException("Circular buffer cannot have negative or zero capacity.", nameof(capacity));
	...
	{
		return _buffer.AsSpan(start, end);
	}
